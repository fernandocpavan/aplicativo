...
public class FornecedorGui extends javax.swing.JFrame {
    ...
    public FornecedorGui() {
        ...
        lista = a.listarFornecedor();

        //cria o modelo de Produto      
        model = new FornecedorTableModel(lista);
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(98, 98, 98)
                                .add(jLabel1))
                            .add(jScrollPane2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 597, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(59, 59, 59)
                        .add(btInserir)
                        .add(18, 18, 18)
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirFornecedorGui im = new InserirFornecedorGui(model);
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            Fornecedor m = model.getFornecedor(selecionado);
            FornecedorController mc = new FornecedorController();
            if (mc.excluir(m.getId())){
            model.removeFornecedor(selecionado);
            }
        } else {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            Integer cdFornecedor = (Integer) model.getValueAt(selecionado, 0);
            AtualizarFornecedorGui am = new AtualizarFornecedorGui(selecionado, cdFornecedor, model);
    ...
    private void efetuaPesquisa() {
        ...
        List<Fornecedor> lista = new ArrayList<Fornecedor>();
        FornecedorController a = new FornecedorController();
        lista = a.listarFornecedoresByNome(nome);
        model.limpar();
