...
public class ProdutoGUI extends javax.swing.JFrame {
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirProdutoGui im = new InserirProdutoGui(model);
        im.setVisible(true);
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            if (mc.excluir(i)){
            model.removeProduto(selecionado);
            }
        } else {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            Integer cdProduto = (Integer) model.getValueAt(selecionado, 0);
            AtualizarProdutoGui am = new AtualizarProdutoGui(selecionado, cdProduto, model);
            am.setVisible(true);
        } else {
    ...
    private void efetuaPesquisa() {
        ...
        List<Produto> lista = new ArrayList<Produto>();
        ProdutoController a = new ProdutoController();
        lista = a.listarProdutoByDescricao(descricao);
        model.limpar();
